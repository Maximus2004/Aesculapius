...
val inversePrimary = Color(0xFFAB90F1)
val scrim = Color(0xFFD8D1E9)
val inverseOnSurface = Color(0xFF7FDACC)
val inverseSurface = Color(0xFF00BB9A)
val surfaceTint = Color(0xFFF3BE00)
val outlineVariant = Color(0xFFFD9AB4)
val onErrorContainer = Color(0xFFFC3B69)
val onSecondaryContainer = Color(0x99E7E0F1)
val onTertiaryContainer = Color(0xFFb0afb2)
val errorContainer = Color(0xFFE3E0EA)
val secondaryContainer = Color(0xFFE7E3EE)
