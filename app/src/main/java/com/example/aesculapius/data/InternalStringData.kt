...
val testsList = listOf(
    Test(
        ...
        testDescription = "Проходите ежемесячное тестирование для более качественного понимания Вашей астмы",
    ...
    Test(
        ...
        testDescription = "Оцените свою лечебную дисциплину - это важный шаг к успешному контролю над астмой",
        listOfQuestion = mutableListOf(
            Question(
